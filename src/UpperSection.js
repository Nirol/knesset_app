...
class UpperSection extends React.Component {
    render () {
        return (   
            ...
            <section id="home" className="video-hero" style={{ height: "700px", backgroundImage: "url('./images/cover_img_1.jpg')", backgroundSize: "cover", backgroundPosition: "center center", backgroundAttachment: "fixed" }} dataSection="home">
