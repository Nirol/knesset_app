            ...
            <div className="container">
                <div className="row row-pb-md">
                    ...
                    <div className="col-md-3 colorlib-widget">
                        ...
                        <div className="f-blog">
                            <a href="blog.html" className="blog-img" style={{ backgroundImage: "url('./</div>images/blog-2.jpg')" }}>
                            </a>
                            <div className="desc">
                        ...
                        <div className="f-blog">
                            <a href="blog.html" className="blog-img" style={{ backgroundImage: "url('./</div>images/blog-3.jpg')" }}>
                            </a>
                            <div className="desc">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 text-center">
                            <p>
                                Copyright &copy;2020 All rights reserved | This template is made with <i className="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
                            </p>
                        </div>
                    </div>
                </div>
